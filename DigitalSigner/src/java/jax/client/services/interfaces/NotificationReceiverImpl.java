 ...
 * 
 */
@WebService(name = "NotificationReceiverImpl", targetNamespace = "http://interfaces.services.ws.jax/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface NotificationReceiverImpl {
    ...
    public String documentNotification(
        ...
        DocumentNotificationRequest documentNotificationRequest);
