 ...
 * @author ihuegal
 */
public class BdAAutusu extends OperacionSQL implements InterfazDAO {
    ...
    public String getSelectFiltro() {
        ...
        sb_sql.append(" FROM BD_A_AUTUSU WHERE 1=1 ");
        if (idAutoridad != null) {
    ...
    {
        StringBuilder sb_sql = new StringBuilder("INSERT INTO BD_A_AUTUSU (");
        sb_sql.append("ID_AUTORIDAD");
        sb_sql.append(",ID_USUARIO");
        sb_sql.append(",FE_ALTA");
        sb_sql.append(",FE_DESACTIVO");
    ...
    {
        StringBuilder sb_sql = new StringBuilder("UPDATE BD_A_AUTUSU SET ");
    ...
    {
        StringBuilder sb_sql = new StringBuilder("DELETE BD_A_AUTUSU ");
        sb_sql.append(" WHERE ");
        sb_sql.append("ID_AUTORIDAD = ").append(":ID_AUTORIDAD");
        sb_sql.append(" AND ID_USUARIO = ").append(":ID_USUARIO");
