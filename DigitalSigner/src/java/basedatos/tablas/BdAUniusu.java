 ...
 * @author ihuegal
 */
public class BdAUniusu extends OperacionSQL implements InterfazDAO {
    ...
    public String getSelectFiltro() {
        ...
        sb_sql.append(" FROM BD_A_UNIUSU WHERE 1=1 ");
        if (idUnidad != null) {
    ...
    {
        StringBuilder sb_sql = new StringBuilder("INSERT INTO BD_A_UNIUSU (");
    ...
    {
        StringBuilder sb_sql = new StringBuilder("UPDATE BD_A_UNIUSU SET ");
